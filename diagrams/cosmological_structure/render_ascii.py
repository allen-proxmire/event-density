"""Render ASCII cosmological-structure diagram to high-resolution PNG."""
from PIL import Image, ImageDraw, ImageFont
from pathlib import Path
import sys

HERE = Path(__file__).parent
TXT = HERE / "cosmological_structure.txt"
OUT = HERE / "cosmological_structure_ascii.png"
...
font_size = 46   # >2000 px wide with margin
font = None
