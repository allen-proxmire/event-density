"""Render ASCII theorem-dependency diagram to high-resolution PNG."""
from PIL import Image, ImageDraw, ImageFont
from pathlib import Path
import sys

HERE = Path(__file__).parent
TXT = HERE / "theorem_dependency_graph.txt"
OUT = HERE / "theorem_dependency_graph_ascii.png"
...
font_size = 44   # >= 2000 px wide at ~80 columns
font = None
