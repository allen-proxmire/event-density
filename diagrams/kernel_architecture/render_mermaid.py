"""Render kernel-architecture Mermaid diagram via mermaid.ink.
...
SRC = HERE / "kernel_architecture.mmd"
OUT_WHITE = HERE / "kernel_architecture_mermaid.png"
OUT_TR    = HERE / "kernel_architecture_mermaid_transparent.png"
...
if data_t and data_t.startswith(b"\x89PNG"):
    ...
    print(f"   FAILED to render transparent variant", file=sys.stderr)
