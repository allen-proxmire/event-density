...
**CANDIDATE, positive, confirmed over long runs, requires new (honestly-named) state and two free parameters.** The strongest, cleanest result in the night's whole Higgs/mass probe line — genuine, bounded, survivable, intrinsic slowing, no external reference position, no faked field. Not FORCED (the state channel and its parameters are additions, not derivations), and not yet connected to an actual gauge/EWSB mechanism.
