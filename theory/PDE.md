...
The canonical PDE is *uniquely selected* by the following seven constraints. These are not assumed independently — they are consequences of the choice to derive a minimal field theory of "becoming." The detailed derivation is in `theory/Foundations/ED_Foundational_Paper.md` and the universality proofs are in `theory/Foundations/Appendices/appendix_D_Universality Class.md`.
...
A full statement (with proofs of independence and sufficiency) is in `theory/Foundations/Appendices/appendix_A_Proofs of Independence Results.md` and `theory/Foundations/Appendices/appendix_B_Proofs of Sufficiency Results.md`.

**Uniqueness theorem.** Constraints C1–C7 select the canonical PDE uniquely among all evolution equations on $\rho$. See `theory/Foundations/Appendices/appendix_D_Universality Class.md`, Theorem D.19.
...
**Empirical correspondence:** the mobility law $D(c) = D_0(1 - c/c_{\max})^\beta$ across 10 chemically distinct soft-matter systems (UDM result; $R^2 > 0.986$). See `papers/UDM/`.
...
**Empirical correspondence:** the cluster-merger lensing-mass offset $\ell = D_T / v_{\rm current}$, tested against 7 well-measured clusters and the Finner+25 aggregate sample of 58 subclusters. See `papers/galaxy-15/`.
...
**Empirical correspondence:** RLC-circuit transfer functions and oscillatory phenomena across regimes. See `theory/Numerical_Atlas/numerical_atlas.md`, Sections C.6–C.7.
...
Three architectural facts follow directly from the constitutive structure (proved in `theory/Foundations/Appendices/appendix_C_PDE Analysis.md`):
...
The full architectural analysis is in `theory/Foundations/ED_Foundational_Paper.md`; the rigorous PDE analysis (well-posedness, spectral structure, three-stage convergence theorem) is in `theory/Foundations/Appendices/appendix_C_PDE Analysis.md`.
...
|--------|-------|-------|--------|------------------|
| Quantum | $\hbar / 2mc$ | $\hbar / 2mc^2$ | Reduced Compton scale | `theory/Dimensional_Atlas/ED-Dimensional-01_Quantum_Regime.md` |
| Planck | $\sqrt{\hbar G/c^3}$ | $\sqrt{\hbar G/c^5}$ | Planck length / time | `theory/Dimensional_Atlas/ED-Dimensional-02_Planck_Regime.md` |
| Condensed matter | thermal diffusivity scale | molecular relaxation time | UDM mobility law | `theory/Dimensional_Atlas/ED-Dimensional-03_Condensed_Matter_Regime.md` |
| Galactic | $v_{\rm circ} \cdot L_0 \sim$ kpc | $L_0 / v_{\rm circ}$ | Mistele weak-lensing extent | `theory/Dimensional_Atlas/ED-Dimensional-04_Galactic_Regime.md` |
| Cosmological | $c^2 / H_0$ | $1/H_0$ | Hubble scale | `theory/Dimensional_Atlas/ED-Dimensional-05_Cosmological_Regime.md` |

Across all five regimes, the nondimensional invariant $D_{\rm nd} = 0.3$ holds *exactly*. This is not a fit; it is a structural identity built into the canonical PDE under nondimensionalization, derived in `theory/Dimensional_Atlas/ED-Dimensional-Master_The_Unified_Atlas.md`.

---

## 7. Where to read further

- **`theory/Foundations/`** — the axiomatic derivation, the foundational paper, the ontology paper, and the formal appendices (proofs, universality class, PDE analysis, numerical methods, glossary, references).
- **`theory/Dimensional_Atlas/`** — the five regime mappings + the master atlas synthesis.
- **`theory/Numerical_Atlas/`** — the computational atlas: well-posedness, spectral decay, modal hierarchy, Lyapunov dissipation, bifurcation surface, three-stage convergence — all numerically realized.
- **`theory/README.md`** — short overview of how the PDE underlies the three flagship empirical results.
- **`papers/foundational/`** — the published Foundational Paper (PDF).
- **`papers/UDM/`** — the published UDM paper (mobility channel, soft-matter regime).
- **`papers/galaxy-15/`** — the Galaxy-15 paper (penalty/wake channel, galactic regime).
