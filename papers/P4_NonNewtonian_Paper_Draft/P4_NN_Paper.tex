...
\section{ED Mobility Saturation Predicts Non-Newtonian Rheology --- A
Fluid-Mechanical Extension of the Universal Mobility
Law}\label{ed-mobility-saturation-predicts-non-newtonian-rheology-a-fluid-mechanical-extension-of-the-universal-mobility-law}

\textbf{Author:} Allen Proxmire \textbf{Collaborator:} Claude (AI
collaborator) \textbf{Date:} 30 April 2026 \textbf{Series:}
Event-Density Foundational Theorems --- P4 Non-Newtonian Arc
