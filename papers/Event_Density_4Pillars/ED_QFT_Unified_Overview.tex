...
\urlstyle{same}
\hypersetup{
  pdftitle={Event Density Foundations A Unified Substrate Architecture for Quantum{,} Fluid{,} Gauge{,} and Gravitational Dynamics},
  pdfauthor={Allen Proxmire},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{Event Density Foundations\\
\large A Unified Substrate Architecture for Quantum, Fluid, Gauge, and
