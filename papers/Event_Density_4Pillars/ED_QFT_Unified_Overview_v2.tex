...
\urlstyle{same}
\hypersetup{
  pdftitle={The Event-Density Foundations of Quantum Field Theory A Unified Substrate-to-Continuum Overview},
  pdfauthor={Allen Proxmire},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{The Event-Density Foundations of Quantum Field Theory\\
\large A Unified Substrate-to-Continuum Overview}
