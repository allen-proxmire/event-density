...
| Matter content (fermions, generations, masses, mixing) | **✓ Dirac sector form-complete** — spin-½ from tethering, chirality casting settled, and the substrate→Dirac operator + continuum limit computed (Nielsen–Ninomiya undoubling 16→1 verified, 2026-07-10); **⚠️** generations, masses, mixing value-inherited; graph-native spinor = the channel-topology wall |
...
| Internal consistency (anomalies, no ghosts) | **split (2026-07-10):** conservation-side ✓ (B4 exact Gauss law); clean-substrate baseline ✓ (vector ⟹ trivially anomaly-free, this session); nontrivial chiral cancellation **inherited with the content**; the one "B4-forces-the-constraint" candidate **T4-gated** |
