...
$$
Q̄(x) = (1/V_{\mathrm{cg}}) \int_{cell at x} Q(y) d^{3}y
$$
...
$$
Q̄(x) = Q̄^(0)(x) + (\ell_P/R_{\mathrm{cg}})^{2} Q̄^(2)(x) + (\ell_P/R_{\mathrm{cg}})^{4} Q̄^(4)(x) + ...
$$
...
$$
Order (\ell_P/R_{\mathrm{cg}})^{0}: Standard continuum equations
Order (\ell_P/R_{\mathrm{cg}})^{2}: Substrate-cutoff regularization (R1, mass-gap, etc.)
Order (\ell_P/R_{\mathrm{cg}})^{4}: Increasingly small corrections
$$
...
$$
\Gamma_{\mathrm{cross}}(x_1, x_2) ~ \exp[-\alpha \int_{\mathrm{path}} \sigma(x) d\ell]
$$
