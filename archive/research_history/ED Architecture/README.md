...
Where the foundational essays in **ED Interpretations** establish the
ontological primitives and **ED Physics** derives the cosmological
dynamics, the Architecture series answers a different question: *what is
the internal organization of the ED equation itself?*
...
ones validated in **ED Validation** and placed on rigorous mathematical
...
- **ED-Arch-12** (Canon) — the seven principles tested in ED Validation
  and formalized in Appendix C.
...
| Folder | Relationship |
|--------|-------------|
| **ED Interpretations** | The foundational essays (01-12.5) provide the ontological primitives that the Architecture formalises into PDE structure. The domain interpretations explore the structural meaning of each layer. |
...
| **ED Validation** | Reproduces the architectural principles (P1-P7) computationally with self-contained test scripts and generated outputs. |
