...
OUT = os.path.join(
    ...
    "docs", "figures", "ED-Math-Pipeline_v3.png",
)
...
def build():
    ...
    ax_x, ax_y, ax_w, ax_h = 0.4, 18.20, 21.2, 1.80
    ...
    cg_x, cg_y, cg_w, cg_h = 0.4, 15.90, 21.2, 1.95
    ...
    cr_x, cr_y, cr_w, cr_h = 0.4, 13.70, 21.2, 1.70
    ...
    cn_x, cn_y, cn_w, cn_h = 0.4, 9.85, 21.2, 3.35
