"""
edsim.manuscript.sections — Manuscript section generators.

Each function returns a Markdown string for one section of the
ED-SIM-02 manuscript. Sections are pure text; figure references
use the pattern ![caption](path).
"""
...
def section_title() -> str:
    return """# ED-SIM-02: A Modular Simulation Platform for the Event Density PDE
...
def section_methods(figure_paths: dict) -> str:
    return """## 2. Methods
...
def section_results(figure_paths: dict) -> str:
    energy_fig = figure_paths.get("energy", "figures/energy.png")
    complexity_fig = figure_paths.get("complexity", "figures/complexity.png")
    entropy_fig = figure_paths.get("entropy", "figures/entropy.png")
    morphology_fig = figure_paths.get("morphology", "figures/morphology.png")
    field_fig = figure_paths.get("field_evolution", "figures/field_evolution.png")
    scaling_fig = figure_paths.get("dimensional_scaling", "figures/dimensional_scaling.png")
...
![Field evolution in 2D]({field_fig})
...
![Morphology evolution]({morphology_fig})
...
![Dimensional scaling]({scaling_fig})
...
- ED-SIM-02 Architecture Document: `research/ED Simulation/ED-SIM-02/ED-SIM-02_Architecture.md`
